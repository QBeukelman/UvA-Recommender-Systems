...
#    Updated: 2023/04/06 08:30:50 by quentinbeuk   ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
# Define the coordinates of the point with the circle around it
x = 5
y = 4
...
plt.plot([0, x], [0, y], color='green', linestyle='--')
...
# Draw a circle around the point at x=3, y=3
circle = plt.Circle((x, y), radius=0.3, color='green', fill=False)
